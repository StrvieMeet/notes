...
13 我们在使用random\(随机数\)模块的中的randrange\(2,100\)方法获取到的数据类型是\_\_\_\_\_\_
...
14 我们知道time模块可以对时间进行操作,现在我们使用datetime模块来获取2018-05-22 18:23:46.370885这样的数据的方法是\_\_\_\_\_\_\_\_
